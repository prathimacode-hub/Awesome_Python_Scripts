...
# HOW TO Use it :
- ### User just need to download the file, and run the camera application.py, on local system.
...
# Compilation Steps :
- ### Install tkinter, PIL, cv2, time, threading, os
- ### After that download the code file, and run camera application.py on local system.
- ### Then the script will start running and user can explore more and more about this simple Camera Application.
