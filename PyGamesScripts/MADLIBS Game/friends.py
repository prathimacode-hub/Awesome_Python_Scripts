...
def madlib():
    ...
    print("The F.r.i.e.n.d.s Template")
...
and chandler and phoebe were {verb4} inorder to help Monica. well, that very moment came a {Adj4} voice saying "OHH! My God"
I bet you know whose it was ? ;)"""
