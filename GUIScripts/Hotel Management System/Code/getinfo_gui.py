...
def file_save(): # Function for Save
...
class HOTEL_MANAGEMENT: # Get Info Class Starts
    def __init__(self):
        def gotinfo():
            self.gettininfo = str(self.gather.get()) # get info for a room number
     ...
     #---------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        root.geometry("881x582+249+104") # Setting size of window
        root.title("HOTEL MANAGEMENT")
        root.configure(background="#d9d9d9")

     #---------------------------------------------------------------------------------------------------------------------------------------------------------

        self.Frame1 = Frame(root) # Set a Frame
     ...
     #---------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        self.Text1 = Text(self.Frame1) # Text Heading
     ...
     #---------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        self.Label1 = Label(self.Frame1) # Set Label For Room number entry
     ...
     #---------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        self.Entry1 = Entry(self.Frame1) # Enter number
     ...
     #---------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        self.Button1 = Button(self.Frame1) # Button for Submit Option
     ...
     #---------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        self.Message1 = Message(self.Frame1) # Output Message
